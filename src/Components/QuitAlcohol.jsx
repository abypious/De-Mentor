...
const QuitAlcohol = () => {
  ...
  const AlcoholTasks = {
    ...
    week3: [
      ...
      { day: 4, description: 'Avoid High-Risk Situations', details: 'Stay away from places or people that could tempt you to drink.' },
    ...
    week5: [
      ...
      { day: 5, description: 'Build a Fulfilling Alcohol-Free Life', details: 'Focus on creating a life filled with purpose, joy, and healthy relationships.' },
    ],
  };
