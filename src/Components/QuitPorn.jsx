...
const QuitPorn = () => {
  ...
  const PornTasks = {
    week1: [
      { day: 1, description: 'Acknowledge the Problem', details: 'Recognize the impact of porn use on your life and accept the need for change.' },
      ...
      { day: 3, description: 'Understand Your Triggers', details: 'Identify situations, emotions, or people that prompt porn use.' },
    ...
    week2: [
      { day: 1, description: 'Create a Safe Environment', details: 'Remove pornographic material and related items from your home and places you frequent.' },
      { day: 2, description: 'Explore Treatment Options', details: 'Consider therapy, support groups, or a combination.' },
    ...
    week3: [
      ...
      { day: 4, description: 'Avoid High-Risk Situations', details: 'Stay away from places or people that could tempt you to view porn.' },
    ...
    week4: [
      ...
      { day: 2, description: 'Continue Counseling or Therapy', details: 'Ongoing professional support can help maintain progress and address underlying issues.' },
      ...
      { day: 5, description: 'Stay Committed to Your Recovery', details: 'Reaffirm your commitment to a porn-free life and stay focused on your goals.' },
    ],
    week5: [
      ...
      { day: 2, description: 'Plan for Long-Term Recovery', details: 'Develop strategies to sustain your progress and continue personal growth.' },
      ...
      { day: 5, description: 'Build a Fulfilling Porn-Free Life', details: 'Focus on creating a life filled with purpose, joy, and healthy relationships.' },
    ],
  };
